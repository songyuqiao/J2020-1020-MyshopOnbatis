            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <c:forEach items="${list}" var="c" varStatus="i">
                    <tr>
                        ...
                        <th>¥&nbsp;${c.money}</th>
                        <th>
                            <button type="button" class="btn btn-default" onclick="clearCart(${c.uid})">删除</button>
                        </th>
                    </tr>
    ...
    <div class="row">
        <div class="pull-right" style="margin-right: 40px;">
            ...
            <div>
                ...
                &nbsp;&nbsp;
                <a href="other?action=order&id=${loginUser.id}" class="btn  btn-danger btn-lg">添加收货地址</a>
